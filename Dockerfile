...
COPY omnileads_ui/supervision/package.json ./
RUN npm install
...
COPY supervision_app $INSTALL_PREFIX/ominicontacto/slowsql
COPY slowsql $INSTALL_PREFIX/ominicontacto/supervision_app
