...
echo "Copying code"
cp -a ../../../{api_app,configuracion_telefonia_app,manage.py,ominicontacto,ominicontacto_app,omnileads_ui,reciclado_app,reportes_app,requirements,supervision_app,test,tests,utiles_globales.py} $INSTALL_PREFIX/ominicontacto
