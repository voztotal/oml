    ...
    <div class="grid formgrid mt-1">
      <div class="field sm:col-12 md:col-12 lg:col-6 xl:col-6">
        <label
          ...
          >{{ $t("models.whatsapp.management_form.type") }}*</label
        >
        ...
        >
          {{
            v$.form.tipo.required.$message.replace(
              "Value",
              $t("models.whatsapp.management_form.type")
            )
          }}
        </small>
      </div>
      <div class="field sm:col-12 md:col-12 lg:col-6 xl:col-6">
        <label
          id="management_form_resultado"
          :class="{
            'p-error': v$.form.resultado.$invalid && submitted,
          }"
          >{{ $t("models.whatsapp.management_form.result") }}*</label
        >
        <div class="p-inputgroup mt-2">
          <span class="p-inputgroup-addon">
            <i class="pi pi-list"></i>
        ...
        >
          {{
            v$.form.resultado.required.$message.replace(
              "Value",
              $t("models.whatsapp.management_form.result")
            )
          }}
        </small>
      </div>
    ...
    <div class="grid formgrid mt-1">
      <div class="field sm:col-12 md:col-12 lg:col-6 xl:col-6">
        <label
          ...
          >{{ $t("models.whatsapp.management_form.mean") }}*</label
        >
        <div class="p-inputgroup mt-2">
          <span class="p-inputgroup-addon">
            <i class="pi pi-list"></i>
        ...
        >
          {{
            v$.form.medio.required.$message.replace(
              "Value",
              $t("models.whatsapp.management_form.mean")
            )
          }}
        </small>
      </div>
      <div class="field sm:col-12 md:col-12 lg:col-6 xl:col-6">
        <label
          id="management_form_calificacion"
          :class="{
            'p-error': v$.form.calificacion.$invalid && submitted,
          }"
          >{{ $t("models.whatsapp.management_form.score") }}*</label
        >
        <div class="p-inputgroup mt-2">
          <span class="p-inputgroup-addon">
            <i class="pi pi-list"></i>
        ...
        >
          {{
            v$.form.calificacion.required.$message.replace(
              "Value",
              $t("models.whatsapp.management_form.score")
            )
          }}
        </small>
      </div>
