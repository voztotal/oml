  ...
  <div class="card">
    ...
    >
          ...
          <div class="flex align-items-center justify-content-center">
            <span class="p-input-icon-left">
              ...
              <InputText
                ...
                :placeholder="
                  $t('globals.find_by', {
                    field: $t('models.whatsapp.management_form.phone'),
                  })
                "
              />
            </span>
      ...
      <Column
        ...
        :sortable="true"
        :header="$t('models.whatsapp.management_form.phone')"
      >
      ...
      <Column
        ...
        style="max-width: 15rem"
        :sortable="true"
        :header="$t('models.whatsapp.management_form.agent')"
      >
        <template #body="slotProps">
      ...
      <Column
        ...
        :sortable="true"
        :header="$t('models.whatsapp.management_form.start_datetime')"
      >
        <template #body="slotProps">
      ...
      <Column
        field="end_datetime"
        :sortable="true"
        :header="$t('models.whatsapp.management_form.end_datetime')"
      >
        <template #body="slotProps">
      ...
      <Column
        field="type"
        :sortable="true"
        :header="$t('models.whatsapp.management_form.type')"
      >
        <template #body="slotProps">
      ...
      <Column
        field="mean"
        :sortable="true"
        :header="$t('models.whatsapp.management_form.mean')"
      >
        <template #body="slotProps">
      ...
      <Column
        field="result"
        :sortable="true"
        :header="$t('models.whatsapp.management_form.result')"
      >
        <template #body="slotProps">
      ...
      <Column
        field="score"
        :sortable="true"
        :header="$t('models.whatsapp.management_form.score')"
      >
        <template #body="slotProps">
